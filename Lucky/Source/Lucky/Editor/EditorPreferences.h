...
namespace Lucky
{
    ...
    struct ColorSettings
    {
        ...
        // ---- ImGui UI 颜色 ----
        glm::vec4 WindowBackground       = { 0.2196f, 0.2196f, 0.2196f, 1.0f }; // 普通窗口背景
        glm::vec4 ChildBackground        = { 0.2196f, 0.2196f, 0.2196f, 1.0f }; // 子窗口背景
        glm::vec4 PopupBackground        = { 0.08f, 0.08f, 0.08f, 0.94f };      // 弹出菜单/工具提示背景
        
        glm::vec4 BorderColor            = { 0.098f, 0.098f, 0.098f, 1.0f };    // 边框颜色
        glm::vec4 BorderShadowColor      = { 0.098f, 0.098f, 0.098f, 1.0f };    // 边框阴影
        
        glm::vec4 FrameBackground        = { 0.165f, 0.165f, 0.165f, 1.0f };    // 控件背景（输入框、复选框等）
        glm::vec4 FrameBackgroundHovered = { 0.165f, 0.165f, 0.165f, 1.0f };    // 控件背景（悬停）
        glm::vec4 FrameBackgroundActive  = { 0.165f, 0.165f, 0.165f, 1.0f };    // 控件背景（激活）
        ...
        glm::vec4 HeaderActive           = { 0.243f, 0.243f, 0.243f, 1.0f };    // 标题头（激活）
        
        glm::vec4 TitleBarBackground     = { 0.157f, 0.157f, 0.157f, 1.0f };    // 标题栏背景
        glm::vec4 MenuBarBackground      = { 0.14f, 0.14f, 0.14f, 1.0f };       // 菜单栏背景
        
        glm::vec4 TabColor               = { 0.157f, 0.157f, 0.157f, 1.0f };    // Tab 标签
        glm::vec4 TabHovered             = { 0.38f, 0.3805f, 0.381f, 1.0f };    // Tab 标签（悬停）
        glm::vec4 TabActive              = { 0.28f, 0.2805f, 0.281f, 1.0f };    // Tab 标签（激活）
        
        glm::vec4 TextColor              = { 0.825f, 0.825f, 0.825f, 1.0f };    // 文字颜色
        ...
        glm::vec4 SeparatorColor         = { 0.098f, 0.098f, 0.098f, 1.0f };    // 分隔线颜色
        ...
        glm::vec4 TableBorderLight       = { 0.098f, 0.098f, 0.098f, 1.0f };    // 表格内边框
