...
namespace Lucky::UI::Theme
{
    ...
    namespace Layout
    {
        ...
        constexpr float WindowRounding = 0.0f;              // 窗口圆角半径
        constexpr float WindowBorderSize = 1.0f;            // 窗口边框大小
        constexpr float WindowMinSizeX = 32.0f;             // 窗口最小尺寸 X
        constexpr float WindowMinSizeY = 32.0f;             // 窗口最小尺寸 Y
        ...
        constexpr float ChildRounding = 0.0f;               // 子窗口圆角半径
        constexpr float ChildBorderSize = 1.0f;             // 子窗口边框大小
        constexpr float PopupRounding = 0.0f;               // 弹出窗口圆角半径
        constexpr float PopupBorderSize = 1.0f;             // 弹出窗口边框大小
        constexpr float FramePaddingX = 4.0f;               // 框架内边距 X
        constexpr float FramePaddingY = 3.0f;               // 框架内边距 Y
        constexpr float FrameRounding = 0.0f;               // 框架圆角半径
        constexpr float FrameBorderSize = 0.0f;             // 框架边框大小
        ...
        constexpr float ScrollbarSize = 14.0f;              // 滚动条大小
        constexpr float ScrollbarRounding = 9.0f;           // 滚动条圆角半径
        constexpr float GrabMinSize = 10.0f;                // 抓取最小大小
        constexpr float GrabRounding = 0.0f;                // 抓取圆角半径
        constexpr float LogSliderDeadzone = 4.0f;           // 对数滑块死区
        constexpr float TabRounding = 4.0f;                 // 标签页圆角半径
